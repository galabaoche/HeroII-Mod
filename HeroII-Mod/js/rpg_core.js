...
Graphics._makeErrorHtml = function(name, message) {
    if(LocalData.Fmii==20180108){
        return ('<font color="yellow" style="font-size: 31px;font-family: GameFont"><b>' + '客户端暂未激活' + '</b></font><br>' +
        '<font color="white" style="font-size: 24px;font-family: GameFont">' + '[请进行一次联网激活游戏]' + '</font><br>');
    }else{
...
Decrypter.readEncryptionkey = function(){
    this._encryptionKey = localStorage.getItem("Fmii").split(/(.{2})/).filter(Boolean);
};