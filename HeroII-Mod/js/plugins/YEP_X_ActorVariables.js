...
//=============================================================================
 /*:
 * @plugindesc v1.03 好感度系统，放在YEP_StatusMenuCore.js之后
...
Window_StatusInfo.prototype.drawActorVariableColumnRects = function() {
    ...
    for (var i = 0; i < maxCols; ++i) {
      for (var j = 0; j < maxRows; ++j) {
        this.drawDarkRect(dx, dy, dw, this.lineHeight());//宽度
        dy += this.lineHeight()+17;//间距
      }
      dx += dw;
