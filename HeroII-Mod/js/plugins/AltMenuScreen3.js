 ...
 * @default 4
 * 
 * @param maxColsCommand
 * @desc max column at command window
 * @default 4
 * 
 * @param commandRows
...
(function() {
	...
	var maxColsCommandWnd = Number(parameters['maxColsCommand'] || 4);
   ...
   //
    ...
    Scene_Status.prototype.create = function() {
        ...
        this._infoWindow.opacity = 0;
        this._commandWindow.opacity = 0;
        //this._commandWindow.width = this._commandWindow.width-100;
    };
    ...
    Window_MenuStatus.prototype.drawItemImage = function(index) {
        ...
        if(bitmap){
            ...
            this.drawActorFace(actor, rect.x, rect.y + lineHeight * 1.0, w, h);
        }
    ...
    Window_MenuStatus.prototype.drawItemStatus = function(index) {
        ...
        var x = rect.x;
        var y = rect.y;
        var width = rect.width;//选择状态框
        var bottom = y + rect.height-35;
        var lineHeight = this.lineHeight();
        //this.drawActorLevel(actor, x, y + lineHeight * 1, width);
        this.drawActorName(actor, x, bottom - lineHeight * 4, width);
        this.drawActorClass(actor, x+110, bottom - lineHeight * 4, width);
        this.drawActorHp(actor, x, bottom - lineHeight * 3, width);
        this.drawActorMp(actor, x, bottom - lineHeight * 2, width);
        this.drawActorIcons(actor, x, bottom - lineHeight * 1, width);
        //this.drawActorIcons(actor, x, y + lineHeight * 1, width);
        this.drawActorTp(actor, x, bottom - lineHeight, width);
    };
